...
public class UpdateBuyer extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 520, 100, 40));
        ...
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 520, 100, 40));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3307/bms","root","mysql");  
        Statement st=con.createStatement();
        st.execute("update buyer SET name='"+name+"',contactNo='"+pno+"',email='"+email+"',address = '"+address+"' where contactNo='"+jTextField5.getText()+"';");
